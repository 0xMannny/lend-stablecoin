...
def test_transferFrom_sender_balance_decreases(accounts, token):
    sender_balance = token.balanceOf(accounts[0])
    amount = sender_balance // 4
...
def test_transferFrom_receiver_balance_increases(accounts, token):
...
def test_transferFrom_caller_balance_not_affected(accounts, token):
...
def test_transferFrom_caller_approval_affected(accounts, token):
...
def test_transferFrom_receiver_approval_not_affected(accounts, token):
    approval_amount = token.balanceOf(accounts[0])
    transfer_amount = approval_amount // 4
...
def test_transferFrom_total_supply_not_affected(accounts, token):
    total_supply = token.totalSupply()
    amount = token.balanceOf(accounts[0])
...
def test_transferFrom_returns_true(accounts, token):
    amount = token.balanceOf(accounts[0])
    token.approve(accounts[1], amount, {"from": accounts[0]})
...
def test_transferFrom_full_balance(accounts, token):
    amount = token.balanceOf(accounts[0])
    receiver_balance = token.balanceOf(accounts[2])
...
def test_transferFrom_zero_tokens(accounts, token):
    sender_balance = token.balanceOf(accounts[0])
    receiver_balance = token.balanceOf(accounts[2])
...
def test_transferFrom_zero_tokens_without_approval(accounts, token):
    sender_balance = token.balanceOf(accounts[0])
    receiver_balance = token.balanceOf(accounts[2])
...
def test_transferFrom_insufficient_balance(accounts, token):
    balance = token.balanceOf(accounts[0])
...
def test_transferFrom_insufficient_approval(accounts, token):
    balance = token.balanceOf(accounts[0])
...
def test_transferFrom_no_approval(accounts, token):
    balance = token.balanceOf(accounts[0])
...
def test_transferFrom_revoked_approval(accounts, token):
    balance = token.balanceOf(accounts[0])
...
def test_transferFrom_to_self(accounts, token):
    sender_balance = token.balanceOf(accounts[0])
    amount = sender_balance // 4
...
def test_transferFrom_to_self_no_approval(accounts, token):
    amount = token.balanceOf(accounts[0])
...
def test_transferFrom_event_fires(accounts, token):
    amount = token.balanceOf(accounts[0])
